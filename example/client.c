/* 
 * This is a simple 'client' demo presenting the capabilites of isogeny-based key exchange.
...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        int n_encrypted;
        EVP_EncryptUpdate(enc_ctx, (unsigned char *) enc_buffer, &n_encrypted, (unsigned char *)input, len);
