...
test_msidh: test_msidh.c proto_msidh.c proto_msidh.h pprod.h pprod.c ec_mont.c ec_mont.h
	gcc fp2.c test_msidh.c proto_msidh.c pprod.c ec_mont.c -g -o test_msidh -Wextra -Wall -lgmp
