...
/*
 * @brief Print the x-coordinate of the point P = (X : Z) with assertion that Z
 * == 1
 */
...
/*
 * @brief Compare the x-only coordinate of point by normalization of P and
 * initalization of the const char* str.
 */
